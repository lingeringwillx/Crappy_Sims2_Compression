...
namespace qfs {
	...
	/*hashtable where the keys are 2 bytes sequences from src converted to integers
	and the values are a list of the positions where the 2 bytes sequence could be found*/
	class Table {
		private:
			bytes& src;
